...
class Calibration:
    def __init__(self):
        # initialize dobot
        port = list_ports.comports()[2].device
    ...
    def run_calibration(self):
        ...
        default_cali_points = [
                           ...
                           [230, 0, -20, 0],
                           [220, -80, -20, 0],  [180, -150, -20, 0],
                           [220, -180, -20, 0], [260, -100, -20, 0],
                           [285, 0, -20, 0],
                           [305, 0, -20, 0],
                           [290, -110, -20, 0],  [250, -190, -20, 0],
        ...
        img_to_arm_file = r"C:\Users\yfan-\Desktop\DEMO\save_parms\image_to_arm.npy"
        arm_to_img_file = r"C:\Users\yfan-\Desktop\DEMO\save_parms\arm_to_image.npy"
    ...
    def run_recog(self):
        if os.path.exists(r"C:\Users\yfan-\Desktop\DEMO\save_parms\image_to_arm.npy"):
            image_to_arm = np.load(r"C:\Users\yfan-\Desktop\DEMO\save_parms\image_to_arm.npy")
...
if __name__ == "__main__":
    cali = Calibration()
    if not os.path.exists(r"C:\Users\yfan-\Desktop\DEMO\save_parms\image_to_arm.npy") or not os.path.exists(r"C:\Users\yfan-\Desktop\DEMO\save_parms\image_to_arm.npy"):
